...
export const ENV_VAR_ROOT_DIR = 'HYMUI_ROOT_DIR';
export const ENV_VAR_SRC_DIR = 'HYMUI_SRC_DIR';
...
export const ENV_VAR_TMP_DIR = 'HYMUI_TMP_DIR';
export const ENV_VAR_WWW_DIR = 'HYMUI_WWW_DIR';
...
export const ENV_VAR_BUILD_DIR = 'HYMUI_BUILD_DIR'; // 当前环境的编译目录
...
export const ENV_WEBPACK_LOADER = 'HYMUI_WEBPACK_LOADER';
...
export const ENV_PRINT_WEBPACK_DEPENDENCY_TREE = 'HYMUI_PRINT_WEBPACK_DEPENDENCY_TREE';
